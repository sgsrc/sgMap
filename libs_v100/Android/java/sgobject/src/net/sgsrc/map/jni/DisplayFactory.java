...
public class DisplayFactory {
  ...
  public Map3D CreateCanvasToMap3D(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateCanvasToMap3D(swigCPtr, this, h);
    return (cPtr == 0) ? null : new Map3D(cPtr, false);
  }

  public MapEarth CreateCanvasToMapEarth(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateCanvasToMapEarth(swigCPtr, this, h);
    return (cPtr == 0) ? null : new MapEarth(cPtr, false);
  }

  public MapAR CreateCanvasToMapAR(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateCanvasToMapAR(swigCPtr, this, h);
    return (cPtr == 0) ? null : new MapAR(cPtr, false);
  }

  public Widget CreateWidget(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidget(swigCPtr, this, h);
    return (cPtr == 0) ? null : new Widget(cPtr, false);
  }

  public Application CreateWidgetToApplication(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidgetToApplication(swigCPtr, this, h);
    return (cPtr == 0) ? null : new Application(cPtr, false);
  }

  public IndexMapWidget CreateWidgetToIndexMap(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidgetToIndexMap(swigCPtr, this, h);
    return (cPtr == 0) ? null : new IndexMapWidget(cPtr, false);
  }

  public LayerTreeWidget CreateWidgetToLayerTree(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidgetToLayerTree(swigCPtr, this, h);
    return (cPtr == 0) ? null : new LayerTreeWidget(cPtr, false);
  }

  public FeatureAttributeTreeWidget CreateWidgetToFeatureAttributeTree(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidgetToFeatureAttributeTree(swigCPtr, this, h);
    return (cPtr == 0) ? null : new FeatureAttributeTreeWidget(cPtr, false);
  }

  public TabWidget CreateWidgetToTab(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidgetToTab(swigCPtr, this, h);
    return (cPtr == 0) ? null : new TabWidget(cPtr, false);
  }

  public DockWidget CreateWidgetToDock(String h) {
    long cPtr = jniJNI.DisplayFactory_CreateWidgetToDock(swigCPtr, this, h);
    return (cPtr == 0) ? null : new DockWidget(cPtr, false);
  }
